...
// ----------- POST ROUTES -----------
router.post(ROUTES.USER_LEVEL.CREATE, ...adminAuth, ...levelValidatorGroup, createUserLevel)

// ----------- PUT ROUTES -----------
router.put(ROUTES.USER_LEVEL.UPDATE, ...adminAuth, ...levelValidatorGroup, updateUserLevel)
